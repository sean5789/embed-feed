  ...
  <script>
    ...
    function createCard(post) {
      const media = post.video
        ? \`
          <div class="video-wrapper">
            <video src="\${post.video}" autoplay muted loop playsinline webkit-playsinline preload="auto"></video>
    ...
    // ✅ NOUVELLE VERSION SANS ÉCRAN BLANC
    function reloadVideo(video) {
      ...
      newVideo.src = src + (src.includes('?') ? '&' : '?') + 'v=' + Date.now();
